...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_TABLE_NODES =
            ...
            + ");";
    private static final String SQL_DROP_TABLE_NODES = "DROP TABLE IF EXISTS " + Contract.Tables.NODES;
    private static final String SQL_CREATE_TABLE_OUTAGES =
            ...
            + ");";
    private static final String SQL_DROP_TABLE_OUTAGES = "DROP TABLE IF EXISTS " + Contract.Tables.OUTAGES;
    private static final String SQL_CREATE_TABLE_EVENTS =
            ...
            + ");";
    private static final String SQL_DROP_TABLE_EVENTS = "DROP TABLE IF EXISTS " + Contract.Tables.EVENTS;
    private static final String SQL_CREATE_TABLE_ALARMS =
            ...
            + ");";
    private static final String SQL_DROP_TABLE_ALARMS = "DROP TABLE IF EXISTS " + Contract.Tables.ALARMS;
