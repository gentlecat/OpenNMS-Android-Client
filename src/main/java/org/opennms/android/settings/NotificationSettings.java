...
public class NotificationSettings {
    ...
    public static boolean enabled(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context).getBoolean(KEY_NOTIFICATIONS_ENABLED,
                context.getResources().getBoolean(R.bool.default_notifications));
    }

    public static String minSeverity(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context).getString(KEY_MINIMAL_SEVERITY,
                context.getResources().getString(R.string.default_minimal_severity));
    }

    public static int syncRateMinutes(Context context) {
        return Integer.valueOf(PreferenceManager.getDefaultSharedPreferences(context).getString(KEY_SYNC_RATE_MINUTES,
    ...
    public static boolean wifiOnly(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context).getBoolean(KEY_SYNC_WIFI_ONLY,
