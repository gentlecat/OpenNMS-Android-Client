...
public class ConnectionSettings {
    ...
    public static String host(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context)
                .getString(KEY_HOST, context.getResources().getString(R.string.default_host));
    }
    ...
    public static int port(Context context) {
        return Integer.valueOf(PreferenceManager.getDefaultSharedPreferences(context).getString(
                KEY_PORT, String.valueOf(context.getResources().getInteger(R.integer.default_port))));
    }

    public static boolean isHttps(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context)
                .getBoolean(KEY_HTTPS, context.getResources().getBoolean(R.bool.default_https));
    }

    public static String restUrl(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context)
                .getString(KEY_REST_URL, context.getResources().getString(R.string.default_rest_url));
    }

    public static String user(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context)
                .getString(KEY_USER, context.getResources().getString(R.string.default_user));
    }

    public static String password(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context)
                .getString(KEY_PASSWORD, context.getResources().getString(R.string.default_password));
    }
}
