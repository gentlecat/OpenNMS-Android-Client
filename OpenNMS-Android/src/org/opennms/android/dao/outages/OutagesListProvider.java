...
public class OutagesListProvider extends AppContentProvider {
    ...
    static {
        OutagesListProvider.sURIMatcher.addURI(OutagesListProvider.AUTHORITY,
                OutagesListProvider.OUTAGES_BASE_PATH,
                OutagesListProvider.OUTAGES);
        OutagesListProvider.sURIMatcher.addURI(OutagesListProvider.AUTHORITY,
                OutagesListProvider.OUTAGES_BASE_PATH + "/#",
                OutagesListProvider.OUTAGE_ID);
        OutagesListProvider.sURIMatcher.addURI(OutagesListProvider.AUTHORITY,
                OutagesListProvider.OUTAGES_BASE_PATH + "/ipaddress/*",
                OutagesListProvider.OUTAGE_IP_ADDRESS);
    }
